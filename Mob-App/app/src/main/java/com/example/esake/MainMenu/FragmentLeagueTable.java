...
import com.example.esake.Adapters.LeagueRankAdapter;
...
public class FragmentLeagueTable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		List<LeagueRank> leagueRankList;
		...
		try {
			Connector cn = new Connector(MyIP.getIp(),"getLeagueRanking.php?lang=gr&cid=1");
			leagueRankList = cn.league();
