...
public class PlayerStats {
	...
	public PlayerStats(String surname, int total_points, int rating, int shots_made,
					   int perc_2_in, int perc_3_in, int perc_freethrows_in, int total_rebounds,
					   int total_offensive_rebounds, int total_defensive_rebounds, int total_assists,
